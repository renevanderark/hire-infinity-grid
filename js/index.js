 ...
 */function cloneDeep(val,instanceClone){switch(utils.typeOf(val)){case 'object':return cloneObjectDeep(val,instanceClone);case 'array':return cloneArrayDeep(val,instanceClone);default:return utils.clone(val);}}function cloneObjectDeep(obj,instanceClone){if(utils.isObject(obj)){var res={};utils.forOwn(obj,function(obj,key){this[key] = cloneDeep(obj,instanceClone);},res);return res;}else if(instanceClone){return instanceClone(obj);}else {return obj;}}function cloneArrayDeep(arr,instanceClone){var len=arr.length,res=[];var i=-1;while(++i < len) {res[i] = cloneDeep(arr[i],instanceClone);}return res;} /**
 * Expose `cloneDeep`
 */module.exports = cloneDeep;},{"./utils":2}],2:[function(_dereq_,module,exports){'use strict'; /**
 * Lazily required module dependencies
 */var utils=_dereq_('lazy-cache')(_dereq_);var fn=_dereq_;_dereq_ = utils;_dereq_('is-plain-object','isObject');_dereq_('shallow-clone','clone');_dereq_('kind-of','typeOf');_dereq_('for-own');_dereq_ = fn; /**
 * Expose `utils`
 */module.exports = utils;},{"for-own":4,"is-plain-object":8,"kind-of":10,"lazy-cache":11,"shallow-clone":25}],3:[function(_dereq_,module,exports){ /*!
 * for-in <https://github.com/jonschlinkert/for-in>
 *
 * Copyright (c) 2014-2015, Jon Schlinkert.
 * Licensed under the MIT License.
 */'use strict';module.exports = function forIn(o,fn,thisArg){for(var key in o) {if(fn.call(thisArg,o[key],key,o) === false){break;}}};},{}],4:[function(_dereq_,module,exports){ /*!
 * for-own <https://github.com/jonschlinkert/for-own>
 *
 * Copyright (c) 2014-2015, Jon Schlinkert.
 * Licensed under the MIT License.
 */'use strict';var forIn=_dereq_('for-in');var hasOwn=Object.prototype.hasOwnProperty;module.exports = function forOwn(o,fn,thisArg){forIn(o,function(val,key){if(hasOwn.call(o,key)){return fn.call(thisArg,o[key],key,o);}});};},{"for-in":3}],5:[function(_dereq_,module,exports){exports.read = function(buffer,offset,isLE,mLen,nBytes){var e,m;var eLen=nBytes * 8 - mLen - 1;var eMax=(1 << eLen) - 1;var eBias=eMax >> 1;var nBits=-7;var i=isLE?nBytes - 1:0;var d=isLE?-1:1;var s=buffer[offset + i];i += d;e = s & (1 << -nBits) - 1;s >>= -nBits;nBits += eLen;for(;nBits > 0;e = e * 256 + buffer[offset + i],i += d,nBits -= 8) {}m = e & (1 << -nBits) - 1;e >>= -nBits;nBits += mLen;for(;nBits > 0;m = m * 256 + buffer[offset + i],i += d,nBits -= 8) {}if(e === 0){e = 1 - eBias;}else if(e === eMax){return m?NaN:(s?-1:1) * Infinity;}else {m = m + Math.pow(2,mLen);e = e - eBias;}return (s?-1:1) * m * Math.pow(2,e - mLen);};exports.write = function(buffer,value,offset,isLE,mLen,nBytes){var e,m,c;var eLen=nBytes * 8 - mLen - 1;var eMax=(1 << eLen) - 1;var eBias=eMax >> 1;var rt=mLen === 23?Math.pow(2,-24) - Math.pow(2,-77):0;var i=isLE?0:nBytes - 1;var d=isLE?1:-1;var s=value < 0 || value === 0 && 1 / value < 0?1:0;value = Math.abs(value);if(isNaN(value) || value === Infinity){m = isNaN(value)?1:0;e = eMax;}else {e = Math.floor(Math.log(value) / Math.LN2);if(value * (c = Math.pow(2,-e)) < 1){e--;c *= 2;}if(e + eBias >= 1){value += rt / c;}else {value += rt * Math.pow(2,1 - eBias);}if(value * c >= 2){e++;c /= 2;}if(e + eBias >= eMax){m = 0;e = eMax;}else if(e + eBias >= 1){m = (value * c - 1) * Math.pow(2,mLen);e = e + eBias;}else {m = value * Math.pow(2,eBias - 1) * Math.pow(2,mLen);e = 0;}}for(;mLen >= 8;buffer[offset + i] = m & 0xff,i += d,m /= 256,mLen -= 8) {}e = e << mLen | m;eLen += mLen;for(;eLen > 0;buffer[offset + i] = e & 0xff,i += d,e /= 256,eLen -= 8) {}buffer[offset + i - d] |= s * 128;};},{}],6:[function(_dereq_,module,exports){ /**
...
obj.constructor && typeof obj.constructor.isBuffer === 'function' && obj.constructor.isBuffer(obj)));};},{}],7:[function(_dereq_,module,exports){ /*!
 * is-extendable <https://github.com/jonschlinkert/is-extendable>
 *
 * Copyright (c) 2015, Jon Schlinkert.
 * Licensed under the MIT License.
 */'use strict';module.exports = function isExtendable(val){return typeof val !== 'undefined' && val !== null && (typeof val === 'object' || typeof val === 'function');};},{}],8:[function(_dereq_,module,exports){ /*!
 * is-plain-object <https://github.com/jonschlinkert/is-plain-object>
 *
 * Copyright (c) 2014-2015, Jon Schlinkert.
 * Licensed under the MIT License.
 */'use strict';var isObject=_dereq_('isobject');function isObjectObject(o){return isObject(o) === true && Object.prototype.toString.call(o) === '[object Object]';}module.exports = function isPlainObject(o){var ctor,prot;if(isObjectObject(o) === false)return false; // If has modified constructor
...
return true;};},{"isobject":9}],9:[function(_dereq_,module,exports){ /*!
 * isobject <https://github.com/jonschlinkert/isobject>
 *
 * Copyright (c) 2014-2015, Jon Schlinkert.
 * Licensed under the MIT License.
 */'use strict';module.exports = function isObject(val){return val != null && typeof val === 'object' && !Array.isArray(val);};},{}],10:[function(_dereq_,module,exports){(function(Buffer){var isBuffer=_dereq_('is-buffer');var toString=Object.prototype.toString; /**
 * Get the native `typeof` a value.
 *
 * @param  {*} `val`
 * @return {*} Native javascript type
 */module.exports = function kindOf(val){ // primitivies
if(typeof val === 'undefined'){return 'undefined';}if(val === null){return 'null';}if(val === true || val === false || val instanceof Boolean){return 'boolean';}if(typeof val === 'string' || val instanceof String){return 'string';}if(typeof val === 'number' || val instanceof Number){return 'number';} // functions
if(typeof val === 'function' || val instanceof Function){return 'function';} // array
if(typeof Array.isArray !== 'undefined' && Array.isArray(val)){return 'array';} // check for instances of RegExp and Date before calling `toString`
if(val instanceof RegExp){return 'regexp';}if(val instanceof Date){return 'date';} // other objects
var type=toString.call(val);if(type === '[object RegExp]'){return 'regexp';}if(type === '[object Date]'){return 'date';}if(type === '[object Arguments]'){return 'arguments';} // buffer
if(typeof Buffer !== 'undefined' && isBuffer(val)){return 'buffer';} // es6: Map, WeakMap, Set, WeakSet
if(type === '[object Set]'){return 'set';}if(type === '[object WeakSet]'){return 'weakset';}if(type === '[object Map]'){return 'map';}if(type === '[object WeakMap]'){return 'weakmap';}if(type === '[object Symbol]'){return 'symbol';} // typed arrays
if(type === '[object Int8Array]'){return 'int8array';}if(type === '[object Uint8Array]'){return 'uint8array';}if(type === '[object Uint8ClampedArray]'){return 'uint8clampedarray';}if(type === '[object Int16Array]'){return 'int16array';}if(type === '[object Uint16Array]'){return 'uint16array';}if(type === '[object Int32Array]'){return 'int32array';}if(type === '[object Uint32Array]'){return 'uint32array';}if(type === '[object Float32Array]'){return 'float32array';}if(type === '[object Float64Array]'){return 'float64array';} // must be a plain object
return 'object';};}).call(this,_dereq_("buffer").Buffer);},{"buffer":30,"is-buffer":6}],11:[function(_dereq_,module,exports){(function(process){'use strict'; /**
 ...
 * @api public
 */function lazyCache(fn){var cache={};var proxy=function proxy(mod,name){name = name || camelcase(mod); // check both boolean and string in case `process.env` cases to string
if(process.env.UNLAZY === 'true' || process.env.UNLAZY === true || process.env.TRAVIS){cache[name] = fn(mod);}Object.defineProperty(proxy,name,{enumerable:true,configurable:true,get:getter});function getter(){if(cache.hasOwnProperty(name)){return cache[name];}return cache[name] = fn(mod);}return getter;};return proxy;} /**
 * Used to camelcase the name to be stored on the `lazy` object.
 *
 * @param  {String} `str` String containing `_`, `.`, `-` or whitespace that will be camelcased.
 * @return {String} camelcased string.
 */function camelcase(str){if(str.length === 1){return str.toLowerCase();}str = str.replace(/^[\W_]+|[\W_]+$/g,'').toLowerCase();return str.replace(/[\W_]+(\w|$)/g,function(_,ch){return ch.toUpperCase();});} /**
 * Expose `lazyCache`
 */module.exports = lazyCache;}).call(this,_dereq_('_process'));},{"_process":16}],12:[function(_dereq_,module,exports){ /**
...
var result=false;if(value != null && typeof value.toString != 'function'){try{result = !!(value + '');}catch(e) {}}return result;}module.exports = isHostObject;},{}],13:[function(_dereq_,module,exports){ /**
 ...
 * _.isObjectLike(null);
 * // => false
 */function isObjectLike(value){return !!value && typeof value == 'object';}module.exports = isObjectLike;},{}],14:[function(_dereq_,module,exports){var isHostObject=_dereq_('./_isHostObject'),isObjectLike=_dereq_('./isObjectLike'); /** `Object#toString` result references. */var objectTag='[object Object]'; /** Used for built-in method references. */var objectProto=Object.prototype; /** Used to resolve the decompiled source of functions. */var funcToString=Function.prototype.toString; /** Used to infer the `Object` constructor. */var objectCtorString=funcToString.call(Object); /**
 * Used to resolve the [`toStringTag`](http://ecma-international.org/ecma-262/6.0/#sec-object.prototype.tostring)
 * of values.
 */var objectToString=objectProto.toString; /** Built-in value references. */var getPrototypeOf=Object.getPrototypeOf; /**
 ...
 * // => true
 */function isPlainObject(value){if(!isObjectLike(value) || objectToString.call(value) != objectTag || isHostObject(value)){return false;}var proto=getPrototypeOf(value);if(proto === null){return true;}var Ctor=proto.constructor;return typeof Ctor == 'function' && Ctor instanceof Ctor && funcToString.call(Ctor) == objectCtorString;}module.exports = isPlainObject;},{"./_isHostObject":12,"./isObjectLike":13}],15:[function(_dereq_,module,exports){'use strict';var isObject=_dereq_('is-extendable');var forIn=_dereq_('for-in');function mixin(target,objects){if(!isObject(target)){throw new TypeError('mixin-object expects the first argument to be an object.');}var len=arguments.length,i=0;while(++i < len) {var obj=arguments[i];if(isObject(obj)){forIn(obj,copy,target);}}return target;} /**
 * copy properties from the source object to the
 * target object.
 *
 * @param  {*} `value`
 * @param  {String} `key`
 */function copy(value,key){this[key] = value;} /**
 * Expose `mixin`
 */module.exports = mixin;},{"for-in":3,"is-extendable":7}],16:[function(_dereq_,module,exports){ // shim for using process in browser
...
process.versions = {};function noop(){}process.on = noop;process.addListener = noop;process.once = noop;process.off = noop;process.removeListener = noop;process.removeAllListeners = noop;process.emit = noop;process.binding = function(name){throw new Error('process.binding is not supported');};process.cwd = function(){return '/';};process.chdir = function(dir){throw new Error('process.chdir is not supported');};process.umask = function(){return 0;};},{}],17:[function(_dereq_,module,exports){'use strict';function thunkMiddleware(_ref){var dispatch=_ref.dispatch;var getState=_ref.getState;return function(next){return function(action){return typeof action === 'function'?action(dispatch,getState):next(action);};};}module.exports = thunkMiddleware;},{}],18:[function(_dereq_,module,exports){'use strict';var _extends=Object.assign || function(target){for(var i=1;i < arguments.length;i++) {var source=arguments[i];for(var key in source) {if(Object.prototype.hasOwnProperty.call(source,key)){target[key] = source[key];}}}return target;};exports.__esModule = true;exports["default"] = applyMiddleware;var _compose=_dereq_('./compose');var _compose2=_interopRequireDefault(_compose);function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};} /**
 ...
 */function applyMiddleware(){for(var _len=arguments.length,middlewares=Array(_len),_key=0;_key < _len;_key++) {middlewares[_key] = arguments[_key];}return function(createStore){return function(reducer,initialState,enhancer){var store=createStore(reducer,initialState,enhancer);var _dispatch=store.dispatch;var chain=[];var middlewareAPI={getState:store.getState,dispatch:function dispatch(action){return _dispatch(action);}};chain = middlewares.map(function(middleware){return middleware(middlewareAPI);});_dispatch = _compose2["default"].apply(undefined,chain)(store.dispatch);return _extends({},store,{dispatch:_dispatch});};};}},{"./compose":21}],19:[function(_dereq_,module,exports){'use strict';exports.__esModule = true;exports["default"] = bindActionCreators;function bindActionCreator(actionCreator,dispatch){return function(){return dispatch(actionCreator.apply(undefined,arguments));};} /**
 ...
 */function createStore(reducer,initialState,enhancer){if(typeof initialState === 'function' && typeof enhancer === 'undefined'){enhancer = initialState;initialState = undefined;}if(typeof enhancer !== 'undefined'){if(typeof enhancer !== 'function'){throw new Error('Expected the enhancer to be a function.');}return enhancer(createStore)(reducer,initialState);}if(typeof reducer !== 'function'){throw new Error('Expected the reducer to be a function.');}var currentReducer=reducer;var currentState=initialState;var currentListeners=[];var nextListeners=currentListeners;var isDispatching=false;function ensureCanMutateNextListeners(){if(nextListeners === currentListeners){nextListeners = currentListeners.slice();}} /**
   ...
   * @returns {void}
   */function replaceReducer(nextReducer){if(typeof nextReducer !== 'function'){throw new Error('Expected the nextReducer to be a function.');}currentReducer = nextReducer;dispatch({type:ActionTypes.INIT});} // When a store is created, an "INIT" action is dispatched so that every
// reducer returns their initial state. This effectively populates
// the initial state tree.
dispatch({type:ActionTypes.INIT});return {dispatch:dispatch,subscribe:subscribe,getState:getState,replaceReducer:replaceReducer};}},{"lodash/isPlainObject":14}],23:[function(_dereq_,module,exports){(function(process){'use strict';exports.__esModule = true;exports.compose = exports.applyMiddleware = exports.bindActionCreators = exports.combineReducers = exports.createStore = undefined;var _createStore=_dereq_('./createStore');var _createStore2=_interopRequireDefault(_createStore);var _combineReducers=_dereq_('./combineReducers');var _combineReducers2=_interopRequireDefault(_combineReducers);var _bindActionCreators=_dereq_('./bindActionCreators');var _bindActionCreators2=_interopRequireDefault(_bindActionCreators);var _applyMiddleware=_dereq_('./applyMiddleware');var _applyMiddleware2=_interopRequireDefault(_applyMiddleware);var _compose=_dereq_('./compose');var _compose2=_interopRequireDefault(_compose);var _warning=_dereq_('./utils/warning');var _warning2=_interopRequireDefault(_warning);function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};} /*
* This is a dummy function to check if the function name has been altered by minification.
* If the function has been minified and NODE_ENV !== 'production', warn the user.
*/function isCrushed(){}if(process.env.NODE_ENV !== 'production' && typeof isCrushed.name === 'string' && isCrushed.name !== 'isCrushed'){(0,_warning2["default"])('You are currently using minified code outside of NODE_ENV === \'production\'. ' + 'This means that you are running a slower development build of Redux. ' + 'You can use loose-envify (https://github.com/zertosh/loose-envify) for browserify ' + 'or DefinePlugin for webpack (http://stackoverflow.com/questions/30030031) ' + 'to ensure you have the correct code for your production build.');}exports.createStore = _createStore2["default"];exports.combineReducers = _combineReducers2["default"];exports.bindActionCreators = _bindActionCreators2["default"];exports.applyMiddleware = _applyMiddleware2["default"];exports.compose = _compose2["default"];}).call(this,_dereq_('_process'));},{"./applyMiddleware":18,"./bindActionCreators":19,"./combineReducers":20,"./compose":21,"./createStore":22,"./utils/warning":24,"_process":16}],24:[function(_dereq_,module,exports){'use strict';exports.__esModule = true;exports["default"] = warning; /**
...
throw new Error(message); /* eslint-disable no-empty */}catch(e) {} /* eslint-enable no-empty */}},{}],25:[function(_dereq_,module,exports){ /*!
 ...
 * @param  {any} `val`
 * @return {any}
 */function clone(val){var type=utils.typeOf(val);if(clone.hasOwnProperty(type)){return clone[type](val);}return val;}clone.array = function cloneArray(arr){return arr.slice();};clone.date = function cloneDate(date){return new Date(+date);};clone.object = function cloneObject(obj){if(utils.isObject(obj)){return utils.mixin({},obj);}else {return obj;}};clone.regexp = function cloneRegExp(re){var flags='';flags += re.multiline?'m':'';flags += re.global?'g':'';flags += re.ignorecase?'i':'';return new RegExp(re.source,flags);}; /**
 * Expose `clone`
 */module.exports = clone;},{"./utils":28}],26:[function(_dereq_,module,exports){(function(Buffer){var isBuffer=_dereq_('is-buffer');var toString=Object.prototype.toString; /**
 * Get the native `typeof` a value.
 *
 * @param  {*} `val`
 * @return {*} Native javascript type
...
var type=toString.call(val);if(type === '[object RegExp]'){return 'regexp';}if(type === '[object Date]'){return 'date';}if(type === '[object Arguments]'){return 'arguments';} // buffer
if(typeof Buffer !== 'undefined' && isBuffer(val)){return 'buffer';} // es6: Map, WeakMap, Set, WeakSet
if(type === '[object Set]'){return 'set';}if(type === '[object WeakSet]'){return 'weakset';}if(type === '[object Map]'){return 'map';}if(type === '[object WeakMap]'){return 'weakmap';}if(type === '[object Symbol]'){return 'symbol';} // must be a plain object
return 'object';};}).call(this,_dereq_("buffer").Buffer);},{"buffer":30,"is-buffer":6}],27:[function(_dereq_,module,exports){(function(process){'use strict'; /**
 * Cache results of the first function call to ensure only calling once.
 *
 * ```js
 * var utils = require('lazy-cache')(require);
 ...
 * @api public
 */function lazyCache(fn){var cache={};var proxy=function proxy(mod,name){name = name || camelcase(mod); // check both boolean and string in case `process.env` cases to string
if(process.env.UNLAZY === 'true' || process.env.UNLAZY === true){cache[name] = fn(mod);}Object.defineProperty(proxy,name,{enumerable:true,configurable:true,get:getter});function getter(){if(cache.hasOwnProperty(name)){return cache[name];}return cache[name] = fn(mod);}return getter;};return proxy;} /**
 * Used to camelcase the name to be stored on the `lazy` object.
 *
 * @param  {String} `str` String containing `_`, `.`, `-` or whitespace that will be camelcased.
 * @return {String} camelcased string.
...
byteArray.push(str.charCodeAt(i) & 0xFF);}return byteArray;}function utf16leToBytes(str,units){var c,hi,lo;var byteArray=[];for(var i=0;i < str.length;i++) {if((units -= 2) < 0)break;c = str.charCodeAt(i);hi = c >> 8;lo = c % 256;byteArray.push(lo);byteArray.push(hi);}return byteArray;}function base64ToBytes(str){return base64.toByteArray(base64clean(str));}function blitBuffer(src,dst,offset,length){for(var i=0;i < length;i++) {if(i + offset >= dst.length || i >= src.length)break;dst[i + offset] = src[i];}return i;}}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"base64-js":29,"ieee754":5,"isarray":31}],31:[function(_dereq_,module,exports){var toString=({}).toString;module.exports = Array.isArray || function(arr){return toString.call(arr) == '[object Array]';};},{}],32:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};}var _store=_dereq_("../store");var _store2=_interopRequireDefault(_store);var setViewportRect=function setViewportRect(rect){return function(dispatch,getState){dispatch({type:"SET_VIEWBOX_RECT",viewBox:[getState().grid.viewBox[0],getState().grid.viewBox[1],Math.floor(rect.width) - 2,Math.floor(rect.height) - 2],domPos:{x:rect.left,y:rect.top}});};};var moveViewport=function moveViewport(movement){return function(dispatch,getState){var newX=getState().grid.viewBox[0] + movement.x;var newY=getState().grid.viewBox[1] + movement.y;dispatch({type:"SET_VIEWBOX_RECT",viewBox:[newX,newY,getState().grid.viewBox[2],getState().grid.viewBox[3]],domPos:getState().grid.domPos});};};var moveComponent=function moveComponent(movement,idx){return function(dispatch){dispatch({type:"MOVE_COMPONENT",movement:movement,idx:idx});};};var setComponentProps=function setComponentProps(props,idx){return function(dispatch){dispatch({type:"SET_COMPONENT_PROPS",idx:idx,props:props});};};var selectComponent=function selectComponent(idx,next){return function(dispatch,getState){var unsubscribe=_store2["default"].subscribe(function(){unsubscribe();next();});var sel=getState().grid.components.map(function(c,i){return [c,i];}).filter(function(cc){return cc[0].props.selected && !cc[0].props.deleted;});if(sel.length){sel[0][0].props.onDeselect(sel[0][1],sel[0][0].props,function(props){_store2["default"].dispatch(setComponentProps(props,sel[0][1]));});}dispatch({type:"SELECT_COMPONENT",idx:idx});};};var addComponent=function addComponent(component,spec){return function(dispatch,getState){dispatch({type:"ADD_COMPONENT",x:getState().grid.viewBox[0] + spec.x,y:getState().grid.viewBox[1] + spec.y,props:spec.props,component:component});};};exports["default"] = {onResize:function onResize(value){return _store2["default"].dispatch(setViewportRect(value));},onDrag:function onDrag(movement){return _store2["default"].dispatch(moveViewport(movement));},onDragComponent:function onDragComponent(movement,idx){return _store2["default"].dispatch(moveComponent(movement,idx));},onSetComponentProps:function onSetComponentProps(props,idx){return _store2["default"].dispatch(setComponentProps(props,idx));},onAddComponent:function onAddComponent(component,pos){return _store2["default"].dispatch(addComponent(component,pos));},onSelectComponent:function onSelectComponent(idx,next){return _store2["default"].dispatch(selectComponent(idx,next));}};module.exports = exports["default"];},{"../store":42}],33:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _createClass=(function(){function defineProperties(target,props){for(var i=0;i < props.length;i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if("value" in descriptor)descriptor.writable = true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();var _get=function get(_x,_x2,_x3){var _again=true;_function: while(_again) {var object=_x,property=_x2,receiver=_x3;_again = false;if(object === null)object = Function.prototype;var desc=Object.getOwnPropertyDescriptor(object,property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {_x = parent;_x2 = property;_x3 = receiver;_again = true;desc = parent = undefined;continue _function;}}else if("value" in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}}};function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _inherits(subClass,superClass){if(typeof superClass !== "function" && superClass !== null){throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__ = superClass;}var _react=_dereq_("react");var _react2=_interopRequireDefault(_react);var _dragging=_dereq_("./dragging");var _dragging2=_interopRequireDefault(_dragging);var _reactDnd=_dereq_("react-dnd");var _types=_dereq_("./types");exports["default"] = function(DragComponent,DropComponent){var DraggingComponent=(0,_dragging2["default"])(DragComponent);var componentSource={beginDrag:function beginDrag(props){return {dropComponent:DropComponent,props:props};}};function collect(connect,monitor){return {dragSource:connect.dragSource(),dragPreview:connect.dragPreview(),isDragging:monitor.isDragging()};}var Draggable=(function(_React$Component){_inherits(Draggable,_React$Component);function Draggable(){_classCallCheck(this,Draggable);_get(Object.getPrototypeOf(Draggable.prototype),"constructor",this).apply(this,arguments);}_createClass(Draggable,[{key:"render",value:function render(){return this.props.isDragging?this.props.dragPreview(_react2["default"].createElement("div",{key:"drag"},_react2["default"].createElement(DraggingComponent,null))):this.props.dragSource(_react2["default"].createElement("div",null,_react2["default"].createElement(DragComponent,null)));}}]);return Draggable;})(_react2["default"].Component);Draggable.propTypes = {dragPreview:_react2["default"].PropTypes.func.isRequired,dragSource:_react2["default"].PropTypes.func.isRequired,isDragging:_react2["default"].PropTypes.bool.isRequired};return (0,_reactDnd.DragSource)(_types.GRID_ITEM,componentSource,collect)(Draggable);};module.exports = exports["default"];},{"./dragging":34,"./types":37,"react":"react","react-dnd":"react-dnd"}],34:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _createClass=(function(){function defineProperties(target,props){for(var i=0;i < props.length;i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if("value" in descriptor)descriptor.writable = true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();var _get=function get(_x,_x2,_x3){var _again=true;_function: while(_again) {var object=_x,property=_x2,receiver=_x3;_again = false;if(object === null)object = Function.prototype;var desc=Object.getOwnPropertyDescriptor(object,property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {_x = parent;_x2 = property;_x3 = receiver;_again = true;desc = parent = undefined;continue _function;}}else if("value" in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}}};function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _inherits(subClass,superClass){if(typeof superClass !== "function" && superClass !== null){throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__ = superClass;}var _react=_dereq_("react");var _react2=_interopRequireDefault(_react);var _reactDnd=_dereq_("react-dnd");exports["default"] = function(DragComponent){var layerStyles={position:"fixed",pointerEvents:"none",zIndex:1000,left:0,top:0,width:"100%",height:"100%"};var getItemStyles=function getItemStyles(props){var currentOffset=props.currentOffset;if(!currentOffset){return {display:"none"};}var x=currentOffset.x;var y=currentOffset.y;var transform="translate(" + x + "px, " + y + "px)";return {opacity:props.isDragging?"0.5":"1",transform:transform,WebkitTransform:transform};};function collect(monitor){return {item:monitor.getItem(),itemType:monitor.getItemType(),currentOffset:monitor.getSourceClientOffset(),isDragging:monitor.isDragging()};}var Dragging=(function(_React$Component){_inherits(Dragging,_React$Component);function Dragging(){_classCallCheck(this,Dragging);_get(Object.getPrototypeOf(Dragging.prototype),"constructor",this).apply(this,arguments);}_createClass(Dragging,[{key:"render",value:function render(){var isDragging=this.props.isDragging;if(!isDragging){return null;}return _react2["default"].createElement("div",{style:layerStyles},_react2["default"].createElement("div",{style:getItemStyles(this.props)},_react2["default"].createElement(DragComponent,null)));}}]);return Dragging;})(_react2["default"].Component);Dragging.propTypes = {currentOffset:_react2["default"].PropTypes.shape({x:_react2["default"].PropTypes.number.isRequired,y:_react2["default"].PropTypes.number.isRequired}),isDragging:_react2["default"].PropTypes.bool};return (0,_reactDnd.DragLayer)(collect)(Dragging);};module.exports = exports["default"];},{"react":"react","react-dnd":"react-dnd"}],35:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign || function(target){for(var i=1;i < arguments.length;i++) {var source=arguments[i];for(var key in source) {if(Object.prototype.hasOwnProperty.call(source,key)){target[key] = source[key];}}}return target;};var _createClass=(function(){function defineProperties(target,props){for(var i=0;i < props.length;i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if("value" in descriptor)descriptor.writable = true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();var _get=function get(_x,_x2,_x3){var _again=true;_function: while(_again) {var object=_x,property=_x2,receiver=_x3;_again = false;if(object === null)object = Function.prototype;var desc=Object.getOwnPropertyDescriptor(object,property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {_x = parent;_x2 = property;_x3 = receiver;_again = true;desc = parent = undefined;continue _function;}}else if("value" in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}}};function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _inherits(subClass,superClass){if(typeof superClass !== "function" && superClass !== null){throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__ = superClass;}var _react=_dereq_("react");var _react2=_interopRequireDefault(_react);var _infinityGrid=_dereq_("./infinity-grid");var _infinityGrid2=_interopRequireDefault(_infinityGrid);var _actions=_dereq_("../actions");var _actions2=_interopRequireDefault(_actions);var _store=_dereq_("../store");var _store2=_interopRequireDefault(_store);var App=(function(_React$Component){_inherits(App,_React$Component);function App(props){_classCallCheck(this,App);_get(Object.getPrototypeOf(App.prototype),"constructor",this).call(this,props);this.state = _store2["default"].getState();this.unsubscribe = _store2["default"].subscribe(this.onState.bind(this));}_createClass(App,[{key:"componentWillUnmount",value:function componentWillUnmount(){this.unsubscribe();}},{key:"onState",value:function onState(){this.setState(_store2["default"].getState());}},{key:"render",value:function render(){return _react2["default"].createElement("div",{style:{width:"100%",height:"100%"}},_react2["default"].createElement(_infinityGrid2["default"],_extends({},this.state.grid,{actions:_actions2["default"]})));}}]);return App;})(_react2["default"].Component);exports["default"] = App;module.exports = exports["default"];},{"../actions":32,"../store":42,"./infinity-grid":36,"react":"react"}],36:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign || function(target){for(var i=1;i < arguments.length;i++) {var source=arguments[i];for(var key in source) {if(Object.prototype.hasOwnProperty.call(source,key)){target[key] = source[key];}}}return target;};var _slicedToArray=(function(){function sliceIterator(arr,i){var _arr=[];var _n=true;var _d=false;var _e=undefined;try{for(var _i=arr[Symbol.iterator](),_s;!(_n = (_s = _i.next()).done);_n = true) {_arr.push(_s.value);if(i && _arr.length === i)break;}}catch(err) {_d = true;_e = err;}finally {try{if(!_n && _i["return"])_i["return"]();}finally {if(_d)throw _e;}}return _arr;}return function(arr,i){if(Array.isArray(arr)){return arr;}else if(Symbol.iterator in Object(arr)){return sliceIterator(arr,i);}else {throw new TypeError("Invalid attempt to destructure non-iterable instance");}};})();var _createClass=(function(){function defineProperties(target,props){for(var i=0;i < props.length;i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if("value" in descriptor)descriptor.writable = true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();var _get=function get(_x2,_x3,_x4){var _again=true;_function: while(_again) {var object=_x2,property=_x3,receiver=_x4;_again = false;if(object === null)object = Function.prototype;var desc=Object.getOwnPropertyDescriptor(object,property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {_x2 = parent;_x3 = property;_x4 = receiver;_again = true;desc = parent = undefined;continue _function;}}else if("value" in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}}};function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _inherits(subClass,superClass){if(typeof superClass !== "function" && superClass !== null){throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__ = superClass;}var _react=_dereq_("react");var _react2=_interopRequireDefault(_react);var _reactDom=_dereq_("react-dom");var _reactDom2=_interopRequireDefault(_reactDom);var _reactDnd=_dereq_("react-dnd");var _types=_dereq_("./types");var _types2=_interopRequireDefault(_types);var COMPONENT_DOWN=2;var MOUSE_DOWN=1;var MOUSE_UP=0;var range=function range(begin,amount){var interval=arguments.length <= 2 || arguments[2] === undefined?1:arguments[2];var ar=[];for(var i=begin;i < begin + amount;i += interval) {ar.push(i);}return ar;};var target={drop:function drop(props,monitor){var _monitor$getClientOffset=monitor.getClientOffset();var x=_monitor$getClientOffset.x;var y=_monitor$getClientOffset.y;props.actions.onAddComponent(monitor.getItem().dropComponent,{x:x - props.domPos.x,y:y - props.domPos.y,props:monitor.getItem().props});}};var collect=function collect(connect,monitor){return {connectDropTarget:connect.dropTarget(),isOver:monitor.isOver()};};var InfinityGrid=(function(_React$Component){_inherits(InfinityGrid,_React$Component);function InfinityGrid(props){_classCallCheck(this,InfinityGrid);_get(Object.getPrototypeOf(InfinityGrid.prototype),"constructor",this).call(this,props);this.resizeListener = this.onResize.bind(this);this.mousemoveListener = this.onMouseMove.bind(this);this.mouseupListener = this.onMouseUp.bind(this);this.mousePos = this.movement = {};this.mouseState = MOUSE_UP;this.state = {resizeCaught:false,draggingComponent:-1};}_createClass(InfinityGrid,[{key:"componentDidMount",value:function componentDidMount(){window.addEventListener("resize",this.resizeListener);window.addEventListener("mousemove",this.mousemoveListener);window.addEventListener("mouseup",this.mouseupListener);this.commitResize();}},{key:"componentDidUpdate",value:function componentDidUpdate(){if(this.state.resizeCaught){this.commitResize();}}},{key:"componentWillUnmount",value:function componentWillUnmount(){window.removeEventListener("resize",this.resizeListener);window.removeEventListener("mousemove",this.mousemoveListener);window.removeEventListener("mouseup",this.mouseupListener);}},{key:"onMouseDown",value:function onMouseDown(ev){this.mousePos.x = ev.clientX;this.mousePos.y = ev.clientY;this.movement = {x:0,y:0};this.mouseState = this.mouseState === COMPONENT_DOWN?COMPONENT_DOWN:MOUSE_DOWN;}},{key:"onTouchStart",value:function onTouchStart(ev){this.onMouseDown({clientX:ev.touches[0].pageX,clientY:ev.touches[0].pageY});}},{key:"onTouchMove",value:function onTouchMove(ev){this.onMouseMove({clientX:ev.touches[0].pageX,clientY:ev.touches[0].pageY});}},{key:"onMouseMove",value:function onMouseMove(ev){this.movement.x = this.mousePos.x - ev.clientX;this.movement.y = this.mousePos.y - ev.clientY;this.mousePos.x = ev.clientX;this.mousePos.y = ev.clientY;switch(this.mouseState){case MOUSE_DOWN:return this.props.actions.onDrag(this.movement);case COMPONENT_DOWN:if(this.state.draggingComponent === -1){this.setState({draggingComponent:this.componentIndex});}return this.props.actions.onDragComponent(this.movement,this.state.draggingComponent);default:}}},{key:"onMouseUp",value:function onMouseUp(){this.mouseState = MOUSE_UP;this.setState({draggingComponent:-1});}},{key:"commitResize",value:function commitResize(){var me=_reactDom2["default"].findDOMNode(this);if(!me){this.setState({resizeCaught:false});return;}var node=me.parentNode;this.props.actions.onResize(node.getBoundingClientRect());this.setState({resizeCaught:false});}},{key:"onResize",value:function onResize(){this.setState({resizeCaught:true});}},{key:"startComponentDrag",value:function startComponentDrag(idx){this.mouseState = COMPONENT_DOWN;this.componentIndex = idx;}},{key:"changeComponentProps",value:function changeComponentProps(idx,props){this.props.actions.onSetComponentProps(props,idx);}},{key:"onComponentClick",value:function onComponentClick(idx,component){var _this=this;if(this.state.draggingComponent === -1){this.props.actions.onSelectComponent(idx,function(){component.props.onSelect(idx,component.props,function(props){return _this.changeComponentProps(idx,props);});});}}},{key:"render",value:function render(){var _this2=this;var _props$viewBox=_slicedToArray(this.props.viewBox,4);var x=_props$viewBox[0];var y=_props$viewBox[1];var w=_props$viewBox[2];var h=_props$viewBox[3];return this.props.connectDropTarget(_react2["default"].createElement("svg",{id:"grid-svg",onDragStart:function onDragStart(ev){return ev.preventDefault();},onMouseDown:this.onMouseDown.bind(this),onTouchEnd:this.onMouseUp.bind(this),onTouchMove:this.onTouchMove.bind(this),onTouchStart:this.onTouchStart.bind(this),style:{width:this.props.viewBox[2] + 2 + "px",height:this.props.viewBox[3] + 2 + "px"},viewBox:this.props.viewBox.join(" ")},range(this.props.gridSize - x % this.props.gridSize + x - this.props.gridSize,w + this.props.gridSize,this.props.gridSize).map(function(val,i){return _react2["default"].createElement("line",{key:"x-" + i,stroke:"rgb(196,196,196)",x1:val,x2:val,y1:y,y2:y + h});}),range(this.props.gridSize - y % this.props.gridSize + y - this.props.gridSize,h + this.props.gridSize,this.props.gridSize).map(function(val,i){return _react2["default"].createElement("line",{key:"y-" + i,stroke:"rgb(196,196,196)",x1:x,x2:x + w,y1:val,y2:val});}),this.props.components.map(function(component,i){return [component,i];}).filter(function(c){return !c[0].props.deleted;}).map(function(c){var _c=_slicedToArray(c,2);var component=_c[0];var i=_c[1];return _react2["default"].createElement("g",{key:i,transform:"translate(" + component.x + " " + component.y + ")"},_react2["default"].createElement(component.component,_extends({},component.props,{onMouseDown:_this2.startComponentDrag.bind(_this2,i),onMouseUp:_this2.onComponentClick.bind(_this2,i,component),onTouchStart:_this2.startComponentDrag.bind(_this2,i),style:{opacity:_this2.state.draggingComponent === i?.5:1}})));})));}}]);return InfinityGrid;})(_react2["default"].Component);InfinityGrid.propTypes = {actions:_react2["default"].PropTypes.object,components:_react2["default"].PropTypes.array,connectDropTarget:_react2["default"].PropTypes.func,gridSize:_react2["default"].PropTypes.number,viewBox:_react2["default"].PropTypes.array};exports["default"] = (0,_reactDnd.DropTarget)(_types2["default"],target,collect)(InfinityGrid);module.exports = exports["default"];},{"./types":37,"react":"react","react-dnd":"react-dnd","react-dom":"react-dom"}],37:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var GRID_ITEM="GRID_ITEM";exports.GRID_ITEM = GRID_ITEM;exports["default"] = [GRID_ITEM];},{}],38:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};}var _components=_dereq_("./components");var _components2=_interopRequireDefault(_components);var _componentsDraggable=_dereq_("./components/draggable");var _componentsDraggable2=_interopRequireDefault(_componentsDraggable);exports.InfinityGrid = _components2["default"];exports.draggable = _componentsDraggable2["default"];},{"./components":35,"./components/draggable":33}],39:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign || function(target){for(var i=1;i < arguments.length;i++) {var source=arguments[i];for(var key in source) {if(Object.prototype.hasOwnProperty.call(source,key)){target[key] = source[key];}}}return target;};function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};}var _cloneDeep=_dereq_("clone-deep");var _cloneDeep2=_interopRequireDefault(_cloneDeep);var _utilSetIn=_dereq_("./util/set-in");var _utilSetIn2=_interopRequireDefault(_utilSetIn);var initialState={viewBox:[0,0,0,0],gridSize:100,components:[],domPos:{x:0,y:0}};exports["default"] = function(state,action){if(state === undefined)state = initialState;var idx=undefined;switch(action.type){case "SET_VIEWBOX_RECT":return _extends({},state,{viewBox:action.viewBox,domPos:action.domPos});case "ADD_COMPONENT":return _extends({},state,{components:(0,_utilSetIn2["default"])([state.components.length],{x:action.x,y:action.y,props:action.props,component:action.component},(0,_cloneDeep2["default"])(state.components))});case "MOVE_COMPONENT":idx = action.idx;return _extends({},state,{components:(0,_utilSetIn2["default"])([idx],{x:state.components[idx].x - action.movement.x,y:state.components[idx].y - action.movement.y,props:state.components[idx].props,component:state.components[idx].component},(0,_cloneDeep2["default"])(state.components))});case "SET_COMPONENT_PROPS":idx = action.idx;return _extends({},state,{components:(0,_utilSetIn2["default"])([idx,"props"],_extends({},state.components[idx].props,action.props),(0,_cloneDeep2["default"])(state.components))});case "SELECT_COMPONENT":idx = action.idx;return _extends({},state,{components:(0,_cloneDeep2["default"])(state.components).map(function(c,i){return _extends({},c,{props:_extends({},c.props,{selected:i === idx})});})});default:return state;}};module.exports = exports["default"];},{"./util/set-in":41,"clone-deep":1}],40:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};}var _grid=_dereq_("./grid");var _grid2=_interopRequireDefault(_grid);exports["default"] = {grid:_grid2["default"]};module.exports = exports["default"];},{"./grid":39}],41:[function(_dereq_,module,exports){ // Do either of these:
//  a) Set a value by reference if deref is not null
//  b) Set a value directly in to data object if deref is null
"use strict";Object.defineProperty(exports,"__esModule",{value:true});var setEither=function setEither(data,deref,key,val){(deref || data)[key] = val;return data;}; // Set a nested value in data (not unlike immutablejs, but a clone of data is expected for proper immutability)
var setIn=function setIn(_x2,_x3,_x4){var _arguments=arguments;var _again=true;_function: while(_again) {var path=_x2,value=_x3,data=_x4;_again = false;var deref=_arguments.length <= 3 || _arguments[3] === undefined?null:_arguments[3];if(path.length > 1){_arguments = [_x2 = path,_x3 = value,_x4 = data,deref?deref[path.shift()]:data[path.shift()]];_again = true;deref = undefined;continue _function;}else {return setEither(data,deref,path[0],value);}}};exports["default"] = setIn;module.exports = exports["default"];},{}],42:[function(_dereq_,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{"default":obj};}var _redux=_dereq_("redux");var _reducers=_dereq_("../reducers");var _reducers2=_interopRequireDefault(_reducers);var _reduxThunk=_dereq_("redux-thunk");var _reduxThunk2=_interopRequireDefault(_reduxThunk);var data=(0,_redux.combineReducers)(_reducers2["default"]);exports["default"] = (0,_redux.createStore)(data,(0,_redux.applyMiddleware)(_reduxThunk2["default"]));module.exports = exports["default"];},{"../reducers":40,"redux":23,"redux-thunk":17}]},{},[38])(38);});
...
function (props) {
	return _react2["default"].createElement(
		"g",
		{ transform: "translate(-20 -20)" },
		_react2["default"].createElement("rect", _extends({}, props, { fill: props.fill, height: props.size, width: props.size, x: "5", y: "5" }))
	);
} // Render dropped
);
...
function (props) {
	return _react2["default"].createElement(
		"g",
		{ transform: "translate(-20 -20)" },
		_react2["default"].createElement("rect", _extends({}, props, { fill: "rgb(0,0,0)", height: "10", width: "30", x: "5", y: "5" }))
	);
} // Render dropped
);
			...
			return _react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(Circle, {
						fill: "rgb(0,0,0)",
						onDeselect: function (idx, props, setProps) {
							return setProps({ r: 16, fill: "rgb(0,0,0)" });
						},
						onSelect: function (idx, props, setProps) {
							return setProps({ r: 20, fill: "rgb(0,0,255)" });
						},
						r: "16"
					})
				),
				_react2["default"].createElement(
					...
					_react2["default"].createElement(Square, {
						fill: "rgb(0,0,0)",
						onDeselect: function (idx, props, setProps) {
							return setProps({ size: 30, fill: "rgb(0,0,0)" });
						},
						onSelect: function (idx, props, setProps) {
							return setProps({ size: 40, fill: "rgb(0,0,255)" });
						},
						size: "30" })
				),
				_react2["default"].createElement(
					"div",
					{ style: { "display": "inline-block" } },
					_react2["default"].createElement(Rect, { onSelect: function (idx, props, setProps) {
							return setProps({ deleted: true });
						}, size: "30" })
				),
				_react2["default"].createElement(
					"div",
